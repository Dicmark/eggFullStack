...
Algoritmo ejObligatorio3
	...
	Escribir "Ingrese la división que quiere hacer"
	Leer dividendo, divisor
	
	Escribir "Trabajando en la división....."
...
SubProceso divisionPorRestasSucesivas(dividendo Por Referencia , divisor Por Valor)
	...
	Escribir "El resultado de la división es con resto ", dividendo " y cociente ",cociente 
